...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50/30 to-emerald-50/20 font-sans">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 animate-fadeIn">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black leading-tight">
                ...
                <br />
                <span className="bg-linear-to-r from-blue-600 via-emerald-500 to-blue-600 bg-clip-text text-transparent animate-gradient">
                  Reins
                </span>
                <br />
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <a
                  href="#evaluation"
                  className="group relative inline-flex items-center justify-center px-8 py-4 rounded-2xl font-bold text-lg text-white bg-[#28A745] shadow-xl shadow-blue-300/50 hover:shadow-2xl hover:shadow-blue-400/60 transition-all duration-300 transform hover:scale-105"
                >
                  <span className="relative z-10 flex items-center">
                    Évaluer Mon Risque
                    <ChevronRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                  </span>
                  <div className="absolute inset-0 rounded-2xl bg-linear-to-r from-blue-700 to-emerald-600 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                </a>
              ...
              <div className="relative h-full rounded-3xl overflow-hidden shadow-2xl shadow-blue-900/20 border-4 border-white">
                ...
                <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-xl rounded-2xl p-5 shadow-2xl border border-blue-100">
                  <div className="flex items-center space-x-4">
                    <div className="bg-linear-to-br from-emerald-500 to-blue-600 p-3 rounded-xl">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className="group relative bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-slate-100 transform hover:-translate-y-2"
              >
                {/* Image Background */}
                <div className="h-48 overflow-hidden relative">
                  ...
                  <div className={`absolute inset-0 bg-linear-to-br ${danger.color} opacity-80`}></div>
                ...
                {/* Accent Bar */}
                <div className={`h-1.5 bg-linear-to-r ${danger.color}`}></div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            {[
              ...
              <div
                key={idx}
                className="bg-white rounded-3xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 border border-slate-100 group hover:-translate-y-1"
              >
                <div className={`inline-flex p-3 rounded-2xl bg-linear-to-br ${practice.color} text-white mb-4 group-hover:scale-110 transition-transform`}>
                  {practice.icon}
                </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-rose-50 via-orange-50/50 to-amber-50">
        <div className="max-w-7xl mx-auto">
